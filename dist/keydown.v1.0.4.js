...
function k(q,r){if(!q.startsWith(a))return null;
var s=q.slice(a.length).split("--"),t=s.shift();
if(!t||!r)return null;
t=h(t);
if(!t)return null;
...
this.bindings.clear();
this.root.querySelectorAll('[id^="'+a+'"]').forEach(function(r){var s=k(r.id,r.dataset.kdAction);
if(!s)return;
...
return p.controller}
var p={KeydownJS:m,createKeydown:n,normalizeKeyName:f,normalizeShortcut:h,codeToKey:i,eventToShortcut:j,parseBindingId:k,start:o,controller:null};
